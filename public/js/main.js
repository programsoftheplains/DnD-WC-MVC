...
openModalButtons.forEach(button => {
    button.addEventListener('click', () => {
        ...
        console.log(id)
        const path = button.parentNode.parentNode.getAttribute("data-path")
        a = button.parentNode.parentNode.getAttribute("data-a")
        b = button.parentNode.parentNode.getAttribute("data-b")
        cid = button.parentNode.parentNode.getAttribute("data-cid")
